...
\
Контроль происходит по принципу регистрации новых подписчиков, с учетом рекламной кампании (имени ссылки), в рамках которой пришел подписчик. Также фиксируется код языка, который установлен в настройках устройства подписчика. \
\
Затем от стороннего сервиса аналитики ожидаются периодические запросы на ривизию подписчиков в шину событий. В ответ бот вернет актуальный статус проверяемых подписчиков.\
\
